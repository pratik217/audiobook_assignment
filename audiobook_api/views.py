...
from audiobook_api import serializers
from audiobook_api import models
from audiobook_api import permissions
...
class SongViewSet(viewsets.ModelViewSet):
    ...
    authentication_classes = (TokenAuthentication,)
    serializer_class = serializers.SongItemSerializer
    queryset = models.SongItem.objects.all()
    permission_classes = {
...
class PodcastViewSet(viewsets.ModelViewSet):
    """Handles creating, reading and updating profile feed items"""
    authentication_classes = (TokenAuthentication,)
    serializer_class = serializers.PodcastItemSerializer
    queryset = models.PodcastItem.objects.all()
    permission_classes = {
        permissions.UpdateOwnStatus,
        IsAuthenticatedOrReadOnly
    }
...
class AudioBookViewSet(viewsets.ModelViewSet):
    """Handles creating, reading and updating profile feed items"""
    authentication_classes = (TokenAuthentication,)
    serializer_class = serializers.AudioBookItemSerializer
    queryset = models.AudioBookItem.objects.all()
    permission_classes = {
        permissions.UpdateOwnStatus,
        IsAuthenticatedOrReadOnly
    }
